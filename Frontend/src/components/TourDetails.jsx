...
export default function TourDetails() {
  ...
  useEffect(() => {
    if (id) {
      axios
        .get(
          `https://hariye-tour-agency-gxx3.onrender.com/api/readSingleTour/${id}`,
        )
        .then((res) => {
  ...
  const handleBookingSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://hariye-tour-agency-gxx3.onrender.com/api/bookingRegister",
        {
      ...
      <div className="max-w-4xl mx-auto px-4 pt-32">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
          <div className="relative h-[400px]">
            ...
            <div
              className={`absolute bottom-6 left-6 px-4 py-2 rounded-full shadow-xl font-bold text-sm ${
          ...
          <div className="p-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10 p-6 bg-slate-50 rounded-2xl border border-slate-100">
              ...
              <div>
                ...
                <p
                  className={`font-medium ${tour.Available_Spots === 0 ? "text-red-600 font-bold" : ""}`}
                >
                  {tour.Available_Spots === 0
                    ? "FULLY BOOKED"
